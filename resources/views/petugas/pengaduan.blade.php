<x-layout>
    <div class="p-6 sm:p-8">
        <h1 class="text-2xl font-semibold text-gray-800 mb-6">Daftar Pengaduan</h1>
                ...
                @foreach ($hilmi_pengaduan as $hilmi_item)
                    <div
                        ...
                        <div class="relative h-56 overflow-hidden">
                            @if ($hilmi_item->foto)
                                <img src="{{ asset('storage/' . $hilmi_item->foto) }}" alt="Foto Pengaduan"
                            ...
                            <div class="mt-6 space-y-4">
                                ...
                                @if ($hilmi_item->status == '0')
                                    <div class="flex justify-between items-center space-x-2">
                                        <form action="/petugas/pengaduan/{{ $hilmi_item->id_pengaduan }}/terima" method="POST"
                                            class="w-1/2">
                                            @csrf
                                            <button type="submit"
