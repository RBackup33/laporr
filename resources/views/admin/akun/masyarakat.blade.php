                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            ...
                            @forelse ($hilmi_masyarakat as $hilmi_akun)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">{{ $hilmi_akun->nik }}</td>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap flex gap-2">
                                        <a href="/admin/akun/masyarakat/edit/{{ $hilmi_akun->nik }}"
                                            class="text-red-500">
                                        ...
                                        <form action="/admin/akun/masyarakat/{{ $hilmi_akun->nik }}" method="post">
                                            @csrf
                                            @method('delete')
