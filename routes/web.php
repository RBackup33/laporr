...
Route::middleware([RedirectIfAuthenticated::class])->group(function () {
    ...
    Route::get('/hilmi_login', [loginController::class,'showLoginForm'])->name('login');
    Route::get('/hilmi_register', [loginController::class,'showRegisterForm'])->name('register');
...
Route::middleware([RoleMiddleware::class . ':admin'])->group(function () {
    ...
    Route::get('/admin/akun/admin/edit/{hilmi_id_petugas}',[AkunAdminContoller::class,'edit'] )->name('akun.admin.edit');    
    Route::put('/admin/akun/admin/{hilmi_id_petugas}',[AkunAdminContoller::class,'update'] )->name('akun.admin.update');    
    Route::delete('/admin/akun/admin/{hilmi_id_petugas}', [AkunAdminContoller::class, 'destroy'])->name('akun.admin.destroy');
    ...
    Route::get('/admin/akun/petugas/edit/{hilmi_id_petugas}',[AkunPetugasContoller::class,'edit'] )->name('akun.petugas.edit');    
    Route::put('/admin/akun/petugas/{hilmi_id_petugas}',[AkunPetugasContoller::class,'update'] )->name('akun.petugas.update');    
    Route::delete('/admin/akun/petugas/{hilmi_id_petugas}', [AkunPetugasContoller::class, 'destroy'])->name('akun.petugas.destroy');
    ...
    Route::get('/admin/akun/masyarakat/edit/{hilmi_nik}',[AkunMasyarakatContoller::class,'edit'] )->name('akun.masyarakat.edit');    
    Route::put('/admin/akun/masyarakat/edit/{hilmi_nik}',[AkunMasyarakatContoller::class,'update'] )->name('akun.masyarakat.update');    
    Route::delete('/admin/akun/masyarakat/{hilmi_nik}',[AkunMasyarakatContoller::class,'destroy'] )->name('akun.masyarakat.delete');    
    ...
    Route::put('/admin/akun/masyarakat/unverified/{nik}',[AkunMasyarakatContoller::class,'verifikasi'] )->name('akun.masyarakat.akunVerifikasi');    
    Route::delete('/admin/akun/masyarakat/unverified/{hilmi_nik}',[AkunMasyarakatContoller::class,'hapus'] )->name('akun.masyarakat.delete');    
