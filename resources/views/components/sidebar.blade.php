    ...
    <div class="h-full px-3 py-4 overflow-y-auto bg-white border-r border-gray-200">
        <div class="flex items-center justify-between mb-6">
            <div class="flex items-center gap-3">
                ...
                <span class="text-xl font-semibold">LaporKetua</span>
            </div>
        ...
        <nav class="space-y-2">
            ...
            @if(Session('level') == 'admin')
            <a href="{{ route('admin.activity.log') }}" class="flex items-center gap-3 px-4 py-3 {{ request()->routeIs('admin.activity.log') ? 'text-blue-600 bg-blue-50' : 'text-gray-600 hover:bg-gray-50' }} rounded-lg">
