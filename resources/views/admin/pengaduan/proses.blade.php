<x-layout>
    <div class="p-6 sm:p-8 relative min-h-screen">
        <h1 class="text-2xl font-semibold text-gray-800 mb-6">Laporan Dalam Proses</h1>
                    ...
                    <div class="p-6">
                        <div class="flex items-center justify-between mb-4">
                            <div class="flex items-center gap-4">
                                ...
                                <div>
                                    <h3 class="font-semibold text-gray-800 text-lg">{{ $hilmi_item->masyarakat->nama }}
                                    </h3>
                        ...
                        <div class="mt-6 space-y-4">
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex space-x-2">
                                    <form action="/admin/{{ $hilmi_item->id_pengaduan }}/selesai" method="POST">
                                        @csrf
                                        <button type="submit"
                ...
                .then(data => {
                    if (data.message) {
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                <p class="text-sm text-gray-600 mb-1">Tanggal Pengaduan / Laporan</p>
