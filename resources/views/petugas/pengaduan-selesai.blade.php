        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="bg-white rounded-xl border border-gray-200 overflow-hidden shadow-lg hover:shadow-xl transition duration-300 transform hover:-translate-y-1">
                <div class="relative h-56 overflow-hidden">
                    @if($hilmi_item->foto)
                        <img src="{{ asset('storage/' . $hilmi_item->foto) }}" alt="Foto Pengaduan" class="w-full h-full object-cover transition duration-300 transform hover:scale-105">
                    @else
                ...
                <div class="p-6">
                    <div class="flex items-center justify-between mb-4">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                <h3 class="font-semibold text-gray-800 text-lg">{{ $hilmi_item->masyarakat->nama }}</h3>
                                <p class="text-sm text-gray-500">{{ \Carbon\Carbon::parse($hilmi_item->tgl_pengaduan)->format('d M Y') }}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="mt-6 space-y-4">
                        <div class="flex items-center justify-between">
                            <button onclick="openDetailModal('{{ $hilmi_item->id_pengaduan }}')" class="text-blue-600 hover:text-blue-700 text-xs font-medium flex items-center transition duration-300 hover:translate-x-1">
                            ...
                            <div class="flex space-x-2">
                                <button onclick="showResponseForm({{ $hilmi_item->id_pengaduan }})" class="px-4 py-2 bg-blue-500 text-white text-sm font-medium rounded-lg hover:bg-blue-600 transition duration-300 shadow-md hover:shadow-lg transform hover:-translate-y-0.5">
                                    Tanggapi
                                </button>
                            </div>
                        </div>
